  ...
  const sendMessage = async (event) => {
    if (event.key === "Enter" && newMessage.text) {
      ...
      try {
        ...
        formData.append('content', newMessage.text);
        formData.append('chatId', selectedChat._id);
        // setNewMessage({
        //   text: "",
        //   file: undefined
        // });
        console.log(formData, "SYUJNJNJSKNKSJNSKNSKJN")
          ...
          >
            ...
            >
              ...
              <div className="msgInputContainer">
                ...
                />
                <input className='' type="file" ref={fileUploadRef} onChange={e => setNewMessage(prev => ({ ...prev, file: e.target.files[0] }))} />
                <button
                  style={{
                    width: 'auto',
                    height: '100%',
                  ...
                  title="Send"
                ><img src="/send-svgrepo-com.svg" style={{ fill: "white", height: '20px' }} /></button>
              </div>
            </FormControl>
          </Box>
        </>
